...
class MainWindow(QMainWindow):
    ...
    def on_about(self): QMessageBox.about(self, "About Nexus Bus", "Nexus Bus v0.1.0\n\nPeripheral Bus Access for NVIDIA Jetson AGX Orin\n\nCopyright (c) 2026 SoC Centric LLC")
    def on_documentation(self): QMessageBox.information(self, "Documentation", "See docs/ folder.")
    def on_report_issue(self): QMessageBox.information(self, "Report Issue", "github.com/soccentric-jetson-oss/nexus-bus-gui")
    def _refresh(self):
